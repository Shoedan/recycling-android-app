...
import com.example.currentplacedetailsonmap.databinding.FragmentLastMonthBinding;
...
public class LastMonthFragment extends Fragment {
    ...
    public View onCreateView(
        ...
        binding = FragmentLastMonthBinding.inflate(inflater, container, false);

        BarChart barChart = binding.barchart;
        set_stats();
        BarDataSet barDataSet = new BarDataSet(barArrayList,"Last Month Statistics");
    ...
    public void set_stats(){
        ...
        List<Integer> statlist = db.get_lms(requireActivity().getIntent().getExtras().getInt("id"));
